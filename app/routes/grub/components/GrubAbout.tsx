  ...
  return (
    <section className="w-full bg-white py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-sta text-5xl font-bold text-center mb-16">
          Our Story
        </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-14">
          ...
          <div className="flex-1 space-y-8">
            <h3 className="font-sta text-5xl md:text-5xl font-bold leading-tight">
              Fine dining at the beach
            </h3>

            <p className="text-lg md:text-xl leading-9 tracking-wide text-gray-700">
